...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        let view1 = UIView(frame: CGRect(x: 0, y: -30, width: 375, height: 30))
...
//            var capsWasSet = self.setCapsIfNeeded()
    ...
    override func viewDidLayoutSubviews() {
        ...
        let orientationSavvyBounds = CGRect(x: 0, y: 0, width: self.view.bounds.width, height: self.heightForOrientation(self.preferredInterfaceOrientationForPresentation, withTopBanner: false))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.keyboardHeight = self.heightForOrientation(self.preferredInterfaceOrientationForPresentation, withTopBanner: true)
    }
